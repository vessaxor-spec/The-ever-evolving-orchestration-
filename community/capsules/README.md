...
| [TEO-CAPSULE-0007](0007-2026-08-09-routing-not-access.md) | Post-diagnostic functional-v1 boundary: TEO routes intelligence while provider authentication and entitlement remain external user/integrator concerns | `f3eda8289e3d5c85ab59f477e3fdbefdcb5a834d` |
