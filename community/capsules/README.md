...
| [TEO-CAPSULE-0009](0009-2026-08-11-evidence-becomes-authority.md) | Post-v1 evidence becomes a governed authority chain through Route-Outcome Evidence, controlled evaluation, cost attribution, shadow review, qualified-human authority, staged activation, and recovery hardening | `4dea9d38a6e7f362f71e711ef479b92ca9268a91` |
| [TEO-CAPSULE-0010](0010-2026-08-17-evidence-qualification-stewardship.md) | Regulated evidence moves from calendar waiting to executable stability qualification while continuous monitoring, bounded authority, and post-v1 stewardship remain explicit | `f7ade2c1d2de6a8a4546f81c49b9268648d6ac7d` |
